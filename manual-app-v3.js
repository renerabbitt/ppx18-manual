...
const generalTitles=new Set(['Index','Why the Pro Plan?','Limited use agreement','Tech Support and Training','Help Folder','Update or Install Instructions','Transfer to Pro Plan','Pre-built showers','Pro Plan Custom Font','Performance Optimizations','Glossary','Troubleshooting','Completely Remove Chief Architect X18 for a Fresh Install']);
